...
export class LoginComponent implements OnInit {
  ...
  private fnLogin() {
    this.route.queryParams
      .subscribe(params => this.toRoute = params['return'] || '')
    return this.fbServices.login(this.email, this.password, this.toRoute)
  }
  ...
  ngAfterViewInit() {
    if (this.fbServices.getCurrentUser()) {
